...
internal object TrainingConstants {
    ...
    const val DELOAD_WEEK_MODULO      = 7
    const val DELOAD_WEEK_INDEX       = 6
    ...
    const val FACTOR_AGE_MASTERS           = 0.90f   // 36–49
    const val FACTOR_AGE_SENIOR            = 0.80f   // 50+
    const val FACTOR_LIFESTYLE_SEDENTARY   = 1.10f
    const val FACTOR_LIFESTYLE_ACTIVE      = 0.90f
    const val FACTOR_LIFESTYLE_VERY_ACTIVE = 0.80f

    // ── Sex rep offset (Schoenfeld 2020) ─────────────────────────────────────
    const val FEMALE_REP_OFFSET_COMPOUND  = 4
    const val FEMALE_REP_OFFSET_ISOLATION = 2

    // ── Age thresholds ────────────────────────────────────────────────────────
    const val AGE_MASTERS = 36
    const val AGE_SENIOR  = 50
