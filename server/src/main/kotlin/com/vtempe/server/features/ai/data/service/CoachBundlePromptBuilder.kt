...
internal fun buildBundlePrompt(
    ...
    return buildString {
        ...
        appendLine()
        appendLine("VALID RESPONSE EXAMPLE (structure only — the ingredients below are generic placeholders, always use restriction-compliant ingredients for the actual athlete):")
        ...
        appendLine("\"nutritionPlan\":{\"weekIndex\":0,\"mealsByDay\":{\"Mon\":[{\"name\":\"Oats with berries\",\"ingredients\":[\"rolled oats\",\"water\",\"berries\"],\"kcal\":360,\"macros\":{\"proteinGrams\":10,\"fatGrams\":6,\"carbsGrams\":64,\"kcal\":358}}]},\"shoppingList\":[\"rolled oats\",\"berries\"]},")
