...
internal fun buildBundlePrompt(
    ...
    return buildString {
        ...
        appendLine(" \"nutritionPlan\": {\"weekIndex\": Int, \"mealsByDay\": {DayLabel: [{\"name\": String, \"ingredients\": [String], \"recipe\": String, \"allergenTags\": [String], \"kcal\": Int, \"macros\": {\"proteinGrams\": Int, \"fatGrams\": Int, \"carbsGrams\": Int, \"kcal\": Int}}]}, \"shoppingList\": [String]},")
        ...
        appendLine("\"nutritionPlan\":{\"weekIndex\":0,\"mealsByDay\":{\"Mon\":[{\"name\":\"Овсянка с ягодами\",\"ingredients\":[\"150г овсяных хлопьев\",\"250мл молока\",\"100г ягод\",\"1 ч.л. мёда\"],\"recipe\":\"1. Залей хлопья молоком, вари 5 мин на среднем огне, помешивая. 2. Сними с огня, добавь ягоды и мёд.\",\"allergenTags\":[\"Gluten\",\"Dairy\"],\"kcal\":360,\"macros\":{\"proteinGrams\":10,\"fatGrams\":6,\"carbsGrams\":64,\"kcal\":358}}]},\"shoppingList\":[\"овсяные хлопья\",\"молоко\",\"ягоды\"]},")
        ...
        appendLine("- INGREDIENTS: always include quantity + unit for each ingredient (e.g. \"150г гречки\", \"200мл кефира\", \"2 яйца\", \"1 ст.л. оливкового масла\"). Never list bare ingredient names without amounts.")
        appendLine("- RECIPE: provide a short 2-4 step cooking instruction in $languageDisplay. Steps should be concise — one action each (\"Отвари гречку 15 мин.\", \"Обжарь курицу на масле 10 мин.\"). Do NOT include nutritional commentary in recipe steps.")
        appendLine("- Example meal object (use restriction-compliant ingredients for the actual athlete): {\"name\":\"Овсянка с ягодами\",\"ingredients\":[\"150г овсяных хлопьев\",\"250мл молока\",\"100г ягод\"],\"recipe\":\"1. Залей хлопья молоком, вари 5 мин. 2. Добавь ягоды.\",\"kcal\":360,\"macros\":{\"proteinGrams\":10,\"fatGrams\":6,\"carbsGrams\":64,\"kcal\":358}}")
